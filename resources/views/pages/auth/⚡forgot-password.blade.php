...
<div class="flex h-dvh flex-col overflow-hidden bg-cream px-5 pb-6 pt-2">
    ...
    @if (! $linkSent)
        {{-- Heading --}}
        <h1 class="mb-1 font-heading text-[24px] font-[800] leading-tight text-bark">{!! nl2br(e(__('auth.forgot_password_title'))) !!}</h1>
    ...
    @else
        {{-- Success State --}}
        <h1 class="mb-1 font-heading text-[24px] font-[800] leading-tight text-bark">{!! nl2br(e(__('auth.reset_password'))) !!}</h1>
