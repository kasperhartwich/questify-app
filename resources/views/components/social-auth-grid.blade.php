@props(['providers' => [], 'phoneEnabled' => false, 'phoneAction' => null])
...
@if ($phoneEnabled)
    <button {{ $phoneAction ? 'wire:click=' . $phoneAction : '' }} class="mb-4 flex w-full items-center justify-center gap-1.5 rounded-xl border-[1.5px] border-cream-border bg-white px-3 py-3 text-[13px] font-semibold text-bark">
