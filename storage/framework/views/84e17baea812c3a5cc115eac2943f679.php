...
<div class="relative flex h-screen flex-col bg-[#E4EDE4]"
    x-data="{
        ...
        markers: [],
        circles: [],
        pins: <?php echo \Illuminate\Support\Js::from($pins)->toHtml() ?>,
        selectedPin: null,
...
>
    ...
    <div class="absolute left-0 right-0 top-[56px] z-10 px-4">
        <div class="flex gap-2">
            ...
            <div class="flex flex-1 items-center gap-2 rounded-[12px] bg-white px-[14px] py-[12px] shadow-[0_2px_10px_rgba(0,0,0,0.15)]">
                ...
                <span class="text-[14px] text-[#B0A898]"><?php echo e(__('general.search_area')); ?>...</span>
            </div>
        </div>
        ...
        <div class="mt-2 flex gap-[6px] overflow-x-auto pb-[2px]">
            ...
            ><?php echo e(__('general.all')); ?></button>
            <button
            ...
            ><?php echo e(__('general.easy')); ?></button>
            <button
            ...
            ><?php echo e(__('general.medium')); ?></button>
            <button
            ...
            ><?php echo e(__('general.hard')); ?></button>
            <button
    ...
    <div class="absolute inset-x-0 bottom-0 z-10 rounded-t-[22px] bg-white px-4 pb-5 pt-3 shadow-[0_-4px_20px_rgba(0,0,0,0.1)]">
        ...
        <p class="mb-3 font-heading text-[15px] font-bold text-bark">
            <span x-text="pins.length"><?php echo e(count($pins)); ?></span> <?php echo e(__('general.quests_in_area')); ?>
        ...
        <template x-if="selectedPin">
            <a :href="'/quests/' + selectedPin.id" class="block overflow-hidden rounded-[16px] bg-white shadow-sm" wire:navigate>
                ...
                <div class="px-4 py-[10px]">
                    <span class="block rounded-[10px] bg-forest-600 py-[10px] text-center text-[13px] font-bold text-white"><?php echo e(__('general.view_quest')); ?> &rarr;</span>
                </div>
            </a>
        </template>
        <template x-if="!selectedPin">
            <p class="py-4 text-center text-[13px] text-muted"><?php echo e(__('general.tap_pin_to_preview')); ?></p>
        </template>
    </div>
</div><?php /**PATH /Users/kasper/Projects/questify-app/storage/framework/views/livewire/views/acc74a48.blade.php ENDPATH**/ ?>